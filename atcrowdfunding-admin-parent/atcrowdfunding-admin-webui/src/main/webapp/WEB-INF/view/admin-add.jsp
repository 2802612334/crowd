    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                ...
                <li><a href="admin/to/main/page.html">数据列表</a></li>
...
<%--                        <input type="hidden" name="keyword" value="${param.keyword}">--%>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword3">登录密码</label>
                            <input name="userPswd" type="password" class="form-control" id="exampleInputPassword3" placeholder="请输入登录账号">
                        </div>
                        <div class="form-group">
